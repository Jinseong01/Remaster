const programs = [
  {
    id: 1,
    title: "발달 장애인 프로그램",
    content: `인천시 거주하는 성인 발달장애인을 위한 프로그램입니다. 이 프로그램에서는 모둠 타악기를 활용하여 참가자들이 서로 협력하고 리듬감을 키울 수 있는 활동을 제공합니다. 또한 미술심리치료를 통해 자신의 감정을 표현하고 내면의 안정감을 찾을 수 있는 시간을 갖습니다. 천연수공예 수업에서는 손재주를 활용한 창작 활동을 통해 성취감을 느낄 수 있으며, 뉴스포츠 시간에는 몸을 움직이며 건강한 생활을 유지하는 데 도움을 줍니다.
              문화 및 여가 동아리에서는 영화 감상, 공연 관람 등 다양한 문화 체험을 통해 여유로운 시간을 보낼 수 있습니다. 생활체육 동아리에서는 배드민턴, 요가, 산책 등을 통해 체력을 키우고 활력을 더할 수 있는 활동들이 준비되어 있습니다. 이를 통해 참가자들은 새로운 친구를 사귀고, 자신의 관심사를 발견하며, 더 나아가 행복한 일상을 누릴 수 있는 기회를 얻을 수 있습니다.`,
  ...
  },
  {
    ...
    interval: "매주 월요일, 화요일 14:00~16:00",
  ...
  },
  {
    id: 4,
    title: "지체장애인 수영교실",
    content: `전문 수영강사와 함께하는 재활 수영 프로그램입니다. 이 프로그램은 수중운동을 통해 신체기능을 향상시키고, 참가자들의 전반적인 건강 증진을 목표로 하고 있습니다. 수중에서 진행되는 다양한 운동은 관절에 부담을 줄이는 동시에 근력을 강화하며, 균형감각과 유연성을 기르는 데 도움을 줍니다.
              또한, 전문 강사의 지도를 통해 개인별 체력과 운동 능력에 맞춘 맞춤형 교육이 이루어지며, 참가자들이 자신감을 얻고 재활에 필요한 신체적, 정신적 회복을 경험할 수 있는 기회를 제공합니다.`,
