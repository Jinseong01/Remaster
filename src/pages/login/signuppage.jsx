...
let SignUpPage = ({ setallUsers,allUsers }) => {
    ...
    const onSubmit = (data) => {
        if(currentStep === 1) {
            ...
            if (Object.keys(disabilityGrades).length !== selectedDisabilities.length) {
...
const disabilityTypes = [
    "지적장애", "지체장애", "뇌병변장애", "시각장애", 
    "청각장애", "언어장애", "자폐성장애", "신장장애",
    "심장장애", "호흡기", "간장애", "안면장애",
    "장루요루", "뇌전증", "상이등급"
];
                        ...
                        <div className="flex-1 overflow-y-auto"> 
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-6">
                                {currentStep === 1 ?(
                                    ...
                                    <>
                                        <div className="space-y-4"> {/* 간격 통일을 위한 wrapper */}
                                            <div className="relative">
                                                <div className="absolute left-3 top-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="relative">
                                                    ...
                                                    <Input
                                                        ...
                                                        {...register("height", {
                                                            required: "키를 입력해주세요",
                                                            min: { value: 100, message: "올바른 키를 입력해주세요" },
                                                            max: { value: 250, message: "올바른 키를 입력해주세요" }
                                                        })}
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <Input
                                                        ...
                                                        {...register("weight", {
                                                            ...
                                                            min: { value: 30, message: "올바른 몸무게를 입력해주세요" },
                                                            max: { value: 200, message: "올바른 몸무게를 입력해주세요" }
                                                        })}
                                                        className="pl-10 pr-12 w-full h-11"
                                                        placeholder="몸무게"
                                                    />
                                            ...
                                            <div className="relative">
                                                ...
                                                {errors.emergency_phone_number && (
                                                    <p className="text-red-500 text-sm mt-1">{errors.emergency_phone_number.message}</p>
                                                )}
                                            </div>
                                            ...
                                            {selectedDisabilities.map((type) => (
                                                <div key={type} className="flex items-center gap-4">
                                                    ...
                                                    <select
                                                        ...
                                                        onChange={(e) => handleGradeSelect(type, e.target.value)}
